...
{
  "require": {
    "elestyle/elepay-php-sdk": ">=1.1.14"
  }
}
```
...
*SquareApi* | [**createSquareTerminalToken**](docs/Api/SquareApi.md#createsquareterminaltoken) | **POST** /terminal/square/token | create square terminal token
*SquareApi* | [**listSquareLocations**](docs/Api/SquareApi.md#listsquarelocations) | **GET** /terminal/square/locations | list Square locations
...
## Documentation For Models
 ...
 - [TerminalTokenDto](docs/Model/TerminalTokenDto.md)
 - [TerminalTokenReq](docs/Model/TerminalTokenReq.md)
