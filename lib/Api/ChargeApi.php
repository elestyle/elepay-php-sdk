...
class ChargeApi
{
     ...
     */
    public function captureCharge($id, $chargeCaptureReq = null)
    {
        list($response) = $this->captureChargeWithHttpInfo($id, $chargeCaptureReq);
        return $response;
    }
     ...
     */
    public function captureChargeWithHttpInfo($id, $chargeCaptureReq = null)
    {
        $request = $this->captureChargeRequest($id, $chargeCaptureReq);
     ...
     */
    public function captureChargeAsync($id, $chargeCaptureReq = null)
    {
        return $this->captureChargeAsyncWithHttpInfo($id, $chargeCaptureReq)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function captureChargeAsyncWithHttpInfo($id, $chargeCaptureReq = null)
    {
        $returnType = '\Elepay\Model\ChargeDto';
        $request = $this->captureChargeRequest($id, $chargeCaptureReq);
     ...
     */
    public function captureChargeRequest($id, $chargeCaptureReq = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createChargeRequest($chargeReq)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listChargesRequest($paymentMethod = null, $from = null, $to = null, $dateField = null, $status = null, $limit = 20, $offset = 0, $sort = null, $order = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveChargeRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function retrieveChargeStatus($id)
    {
        list($response) = $this->retrieveChargeStatusWithHttpInfo($id);
        return $response;
    }
     ...
     */
    public function retrieveChargeStatusWithHttpInfo($id)
    {
        $request = $this->retrieveChargeStatusRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveChargeStatusAsync($id)
    {
        return $this->retrieveChargeStatusAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveChargeStatusAsyncWithHttpInfo($id)
    {
        $returnType = '\Elepay\Model\ChargeStatusDto';
        $request = $this->retrieveChargeStatusRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveChargeStatusRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function revokeChargeRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
