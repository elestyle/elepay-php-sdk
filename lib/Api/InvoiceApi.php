...
class InvoiceApi
{
     ...
     */
    public function cancelInvoiceRequest($invoiceId)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createInvoiceRequest($invoiceReq)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteInvoiceRequest($invoiceId)
    {
        // verify the required parameter 'invoiceId' is set
        if ($invoiceId === null || (is_array($invoiceId) && count($invoiceId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listInvoicesRequest($keyword = null, $from = null, $to = null, $status = null, $limit = 20, $offset = 0)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveInvoiceRequest($invoiceId)
    {
        // verify the required parameter 'invoiceId' is set
        if ($invoiceId === null || (is_array($invoiceId) && count($invoiceId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendInvoiceRequest($invoiceId)
    {
        // verify the required parameter 'invoiceId' is set
        if ($invoiceId === null || (is_array($invoiceId) && count($invoiceId) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->submitInvoiceWithHttpInfo($invoiceId);
        return $response;
    }
     ...
     * @return array of \Elepay\Model\InvoiceDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitInvoiceWithHttpInfo($invoiceId)
    {
        $request = $this->submitInvoiceRequest($invoiceId);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submitInvoiceAsync($invoiceId)
    {
        return $this->submitInvoiceAsyncWithHttpInfo($invoiceId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submitInvoiceAsyncWithHttpInfo($invoiceId)
    {
        $returnType = '\Elepay\Model\InvoiceDto';
        $request = $this->submitInvoiceRequest($invoiceId);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function submitInvoiceRequest($invoiceId)
    {
        // verify the required parameter 'invoiceId' is set
        if ($invoiceId === null || (is_array($invoiceId) && count($invoiceId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateInvoiceRequest($invoiceId, $invoiceReq)
    {
        // verify the required parameter 'invoiceId' is set
        if ($invoiceId === null || (is_array($invoiceId) && count($invoiceId) === 0)) {
            throw new \InvalidArgumentException(
