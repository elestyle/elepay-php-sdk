...
class ChannelPropertiesDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'isSupportSource' => 'bool',
        'isSupportMultipleSource' => 'bool',
        'maxAmount' => 'int',
        'minAmount' => 'int',
        'resourceWebEnv' => '\Elepay\Model\ResourceWebEnvType'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'isSupportSource' => null,
        'isSupportMultipleSource' => null,
        'maxAmount' => null,
        'minAmount' => null,
        'resourceWebEnv' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'isSupportMultipleSource' => false,
		'maxAmount' => false,
		'minAmount' => false,
		'resourceWebEnv' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'isSupportSource' => 'isSupportSource',
        'isSupportMultipleSource' => 'isSupportMultipleSource',
        'maxAmount' => 'maxAmount',
        'minAmount' => 'minAmount',
        'resourceWebEnv' => 'resourceWebEnv'
    ];
    ...
    protected static $setters = [
        ...
        'isSupportSource' => 'setIsSupportSource',
        'isSupportMultipleSource' => 'setIsSupportMultipleSource',
        'maxAmount' => 'setMaxAmount',
        'minAmount' => 'setMinAmount',
        'resourceWebEnv' => 'setResourceWebEnv'
    ];
    ...
    protected static $getters = [
        ...
        'isSupportSource' => 'getIsSupportSource',
        'isSupportMultipleSource' => 'getIsSupportMultipleSource',
        'maxAmount' => 'getMaxAmount',
        'minAmount' => 'getMinAmount',
        'resourceWebEnv' => 'getResourceWebEnv'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('isSupportSource', $data ?? [], null);
        $this->setIfExists('isSupportMultipleSource', $data ?? [], null);
        $this->setIfExists('maxAmount', $data ?? [], null);
        $this->setIfExists('minAmount', $data ?? [], null);
        $this->setIfExists('resourceWebEnv', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets isSupportSource
     *
     * @return bool|null
     */
    public function getIsSupportSource()
    {
        return $this->container['isSupportSource'];
    }

    /**
     * Sets isSupportSource
     *
     * @param bool|null $isSupportSource カスタマ機能とソース true 利用可能 false 利用不可
     *
     * @return self
     */
    public function setIsSupportSource($isSupportSource)
    {

        if (is_null($isSupportSource)) {
            throw new \InvalidArgumentException('non-nullable isSupportSource cannot be null');
        }

        $this->container['isSupportSource'] = $isSupportSource;

        return $this;
    }

    /**
     * Gets isSupportMultipleSource
     *
     * @return bool|null
     */
    public function getIsSupportMultipleSource()
    {
        return $this->container['isSupportMultipleSource'];
    }

    /**
     * Sets isSupportMultipleSource
     *
     * @param bool|null $isSupportMultipleSource 複数ソース true バインディング可能 false バインディング不可
     *
     * @return self
     */
    public function setIsSupportMultipleSource($isSupportMultipleSource)
    {

        if (is_null($isSupportMultipleSource)) {
            throw new \InvalidArgumentException('non-nullable isSupportMultipleSource cannot be null');
        }

        $this->container['isSupportMultipleSource'] = $isSupportMultipleSource;
     ...
     * Sets maxAmount
     *
     * @param int|null $maxAmount 最大可能金額
     *
     * @return self
     */
     ...
     * Sets minAmount
     *
     * @param int|null $minAmount 最小可能金額
     *
     * @return self
     */
     ...
     * Gets resourceWebEnv
     *
     * @return \Elepay\Model\ResourceWebEnvType|null
     */
    public function getResourceWebEnv()
    {
        return $this->container['resourceWebEnv'];
    }

    /**
     * Sets resourceWebEnv
     *
     * @param \Elepay\Model\ResourceWebEnvType|null $resourceWebEnv resourceWebEnv
     *
     * @return self
     */
    public function setResourceWebEnv($resourceWebEnv)
    {

        if (is_null($resourceWebEnv)) {
            throw new \InvalidArgumentException('non-nullable resourceWebEnv cannot be null');
        }

        $this->container['resourceWebEnv'] = $resourceWebEnv;
