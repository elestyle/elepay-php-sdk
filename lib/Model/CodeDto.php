...
class CodeDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('object', $data ?? [], 'code');
        ...
        $this->setIfExists('expiryPeriod', $data ?? [], null);
    ...
    */
    ...
    public function setCodeUrl($codeUrl)
    {
        ...
        if (is_null($codeUrl)) {
            throw new \InvalidArgumentException('non-nullable codeUrl cannot be null');
        }
    ...
    public function setExpiryPeriod($expiryPeriod)
    {
        ...
        if (is_null($expiryPeriod)) {
            throw new \InvalidArgumentException('non-nullable expiryPeriod cannot be null');
        }
