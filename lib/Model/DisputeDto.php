 ...
 */
class DisputeDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DisputeDto';
    ...
    protected static $openAPITypes = [
        ...
        'reason' => 'string',
        'status' => '\Elepay\Model\DisputeStatusType',
        'resolvedTime' => 'int',
        'createTime' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('object', $data ?? [], 'dispute');
        ...
        $this->setIfExists('resolvedTime', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Dispute ID
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason 不審請求理由
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \Elepay\Model\DisputeStatusType|null
     */
     ...
     * Sets status
     *
     * @param \Elepay\Model\DisputeStatusType|null $status status
     *
     * @return self
     */
     ...
     * Sets resolvedTime
     *
     * @param int|null $resolvedTime 対応時間のUTCタイムスタンプ
     *
     * @return self
     */
    public function setResolvedTime($resolvedTime)
    {
        ...
        if (is_null($resolvedTime)) {
            throw new \InvalidArgumentException('non-nullable resolvedTime cannot be null');
        }
     ...
     * Sets createTime
     *
     * @param int|null $createTime 発生時間のUTCタイムスタンプ。
     *
     * @return self
     */
