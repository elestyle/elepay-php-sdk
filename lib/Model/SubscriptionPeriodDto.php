...
/**
 * SubscriptionPeriodDto Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscriptionPeriodDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionPeriodDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object'] = $data['object'] ?? 'subscription_period';
     ...
     * Sets id
     *
     * @param string|null $id Subscription Period ID
     *
     * @return self
     */
     ...
     * Sets startTime
     *
     * @param int|null $startTime 周期開始UTCタイムスタンプ
     *
     * @return self
     */
     ...
     * Sets endTime
     *
     * @param int|null $endTime 周期終了UTCタイムスタンプ
     *
     * @return self
     */
