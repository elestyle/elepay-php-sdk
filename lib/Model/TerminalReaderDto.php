    ...
    */
    ...
    public function setRegistrationCode($registrationCode)
    {
        ...
        if (is_null($registrationCode)) {
            throw new \InvalidArgumentException('non-nullable registrationCode cannot be null');
        }
